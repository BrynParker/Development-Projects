	...
	function PANEL:Init()
		...
		if (!suppress or (suppress and !suppress.all)) then
			...
			if (!suppress or !suppress.attrib) then
				...
				self.attribName:SetFont("bitter")
				...
				self.attribName:SetText("Skills")
