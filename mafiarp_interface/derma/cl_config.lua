local PANEL = {}
	...
	function PANEL:Paint(w, h)
		...
		draw.DrawText("Press 'F1' to close", "NameFactionPingFont", ScrW() * 0.004, ScrH() * 0.004, Color(182, 182, 182, 220), TEXT_ALIGN_LEFT)
	...
	function PANEL:addTab(name, callback, uniqueID)
		...
		local function paintTab(tab, w, h)
			if (self.activeTab == tab) then
				surface.SetDrawColor(Color(43,138,28))
...
vgui.Register("configMenu", PANEL, "EditablePanel")

if (IsValid(nut.gui.menu)) then
	vgui.Create("configMenu")
end